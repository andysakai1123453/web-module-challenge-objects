...
{
  const likeItem = {"name": name, "price": price, "category": category};
  return likeItem;
}
console.log(createMenuItem("pickles",5,"Side"))

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

console.log(createMenuItem("Mountain Dew", 2, "Drink"))
console.log(createMenuItem("Turkey Burger", 10, "Lunch"))
console.log(createMenuItem("MilkShake", 3, "Desert"))
...
reviews.name = "Andy";
reviews.rating = 3;
reviews.feedback = "I abolutely hate this place. The staff are veryu rude and the seats hurt my butt.";
